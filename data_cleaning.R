...
# reproduce results.
writeLines(capture.output(sessionInfo()), "sessionInfo_data_cleaning.txt")
...
write.csv(merged_deidentified, "./data/merged_deidentified.csv",row.names=FALSE)
# save deidentified .rds for r users, has some advantages so I recommend loading this file
saveRDS(merged_deidentified, "./data/merged_deidentified.rds")
