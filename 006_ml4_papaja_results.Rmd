...
[^2]: The random-effects meta-analysis failed to converge. The heterogeneity parameter, $\tau$, was estimated as too small to estimate. To encourage the model to converge, we restricted $\tau$ to zero, creating a fixed-effects meta-analysis.
