...
Critically, protocol version did not significantly predict replication effect size regardless of which exclusion criteria were used. Exclusion Set 1: *b* = `r mixed_effects_1$coefficients["Slope1_1", "Estimate"]`, *Z* = `r mixed_effects_1$coefficients["Slope1_1", "z value"]`, *p* = `r mixed_effects_1$coefficients["Slope1_1", "Pr(>|z|)"]`; Exclusion Set 2: *b* = `r mixed_effects_2$coefficients["Slope1_1", "Estimate"]`, *Z* = `r mixed_effects_2$coefficients["Slope1_1", "z value"]`, *p* = `r mixed_effects_2$coefficients["Slope1_1", "Pr(>|z|)"]`; Exclusion Set 3: *b* = `r mixed_effects_3$coefficients["Slope1_1", "Estimate"]`, *Z* = `r mixed_effects_3$coefficients["Slope1_1", "z value"]`, *p* = `r mixed_effects_3$coefficients["Slope1_1", "Pr(>|z|)"]`. The Author Advised version did not produce significantly larger effect sizes when compared with the In House versions.
