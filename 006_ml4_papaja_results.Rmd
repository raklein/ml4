...
merged <- filter(merged, pass_ER1 == T | expert == 0)
...
# Work in progress
Power calculations in this document are not calculated on the fly and appear very off.
...
merged_excl_2 <- subset(merged, pass_ER2 == T)

# 'merged_excl_3' further excludes participants as per exclusion set 3 (below)

merged_excl_3 <- subset(merged_excl_2, pass_ER3 == T)
```
