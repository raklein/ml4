...
Several exclusions were made, each as specified by our preregistration (https://osf.io/4xx6w). First, data from four labs were excluded for collecting fewer than 60 participants. This excluded 158 participants. Next, some In House sites began data collection before the analysis plan was pre-registered due to their own deadlines. Data collected before the pre-registration were excluded from the confirmatory tests reported in this manuscript. This excluded a further 545 participants. 
