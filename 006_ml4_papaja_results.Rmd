...
[^2]: Supplemental analyses treating these as two separate dependent variables are available in the online supplement (https://osf.io/xtg4u/) but generally follow the same pattern of results reported below.
...
This analysis additionally tests protocol version (In House vs Author Advised) as a moderator. Across the three exclusion sets, protocol version did not significantly predict replication effect size. Exclusion set 1: *b* = `r mixed_effects_1$coefficients["Slope_1", "Estimate"]`, *Z* = `r mixed_effects_1$coefficients["Slope_1", "z value"]`, *p* = `r mixed_effects_1$coefficients["Slope_1", "Pr(>|z|)"]`; exclusion set 2: *b* = `r mixed_effects_2$coefficients["Slope_1", "Estimate"]`, *Z* = `r mixed_effects_2$coefficients["Slope_1", "z value"]`, *p* = `r mixed_effects_2$coefficients["Slope_1", "Pr(>|z|)"]`; exclusion set 3: *b* = `r mixed_effects_3$coefficients["Slope_1", "Estimate"]`, *Z* = `r mixed_effects_3$coefficients["Slope_1", "z value"]`, *p* = `r mixed_effects_3$coefficients["Slope_1", "Pr(>|z|)"]`. 
